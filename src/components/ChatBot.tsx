...
export default function ChatBot() {
  ...
  const botResponses = {
    ...
    // Локация и открытие
    'адрес': 'г. Воронеж, точный адрес сообщим ближе к открытию в декабре 2025! Следите за новостями 📍',
    'воронеж': 'Да, открываемся в Воронеже в декабре 2025! Будем первой профессиональной школой экстремальных видов спорта в городе! 🏆',
    'открытие': 'Грандиозное открытие в декабре 2025! Готовим крутую площадку, набираем лучших тренеров. Скоро будем готовы! 🎊',
    'декабрь': 'Открытие запланировано на декабрь 2025 года! Активно готовимся, ищем идеальную локацию в Воронеже 📅',
    '2025': 'В 2025 году откроемся! Декабрь 2025 - старт нашей большой мечты. Будем лучшей школой экстрима в Воронеже! 🚀',
...
📊 Статистика активности сайта`;
    ...
    if (!botResponse) {
      if (lowerText.match(/(привет|здравствуй|добр|хай|hi)/)) {
        ...
        botResponse = 'До встречи! 👋 Приходите к нам в декабре 2025! KINETIC KIDS ждет вас! 🚀';
      } else {
